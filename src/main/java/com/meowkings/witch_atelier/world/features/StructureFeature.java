package com.meowkings.witch_atelier.world.features;
...
import com.meowkings.witch_atelier.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
    public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, WitchAtelier.MODID);
