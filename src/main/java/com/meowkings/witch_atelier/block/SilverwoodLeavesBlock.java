...
public class SilverwoodLeavesBlock extends Block {
    public SilverwoodLeavesBlock() {
        super(BlockBehaviour.Properties.of().sound(SoundType.AZALEA_LEAVES).strength(0.1f, 1f).requiresCorrectToolForDrops().noOcclusion().randomTicks().pushReaction(PushReaction.DESTROY).isRedstoneConductor((state, getter, position) -> false).ignitedByLava());
    }
