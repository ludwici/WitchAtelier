...
public final class WitchAtelierModBlocks {
    ...
    public static final DeferredBlock<Block> SILVERWOOD_LEAVES = REGISTRY.register("silverwood_leaves", () -> new SilverwoodLeavesBlock(BlockBehaviour.Properties.of().sound(SoundType.AZALEA_LEAVES).strength(0.1f, 1f).noOcclusion().randomTicks().pushReaction(PushReaction.DESTROY).isRedstoneConductor((state, getter, position) -> false).ignitedByLava()));
